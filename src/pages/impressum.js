        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-12">
              <div>
                ...
                <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Der Anbieter wird sich bemühen, den Dienst möglichst unterbrechungsfrei zum Abruf
                      anzubieten. Auch bei aller Sorgfalt können aber Ausfallzeiten nicht ausgeschlossen
                      werden. Der Anbieter behält sich das Recht vor, sein Angebot jederzeit zu ändern
                      oder einzustellen.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      ...
                      oder Link liegenden Inhalte zu Eigen macht. Eine ständige Kontrolle dieser externen
                      Links ist für den Anbieter ohne konkrete Hinweise auf Rechtsverstöße nicht zumutbar.
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Für den Inhalt der Werbeanzeigen ist der jeweilige Autor verantwortlich, ebenso wie
                      für den Inhalt der beworbenen Website. Die Darstellung der Werbeanzeige stellt keine
                      Akzeptanz durch den Anbieter dar.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Mit der Nutzung der Website des Anbieters kommt keinerlei Vertragsverhältnis zwischen
                      dem Nutzer und dem Anbieter zustande. Insofern ergeben sich auch keinerlei vertragliche
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
                    ...
                    Datenbanken oder anderen elektronischen Medien und Systemen. Inhalte und Rechte Dritter
                    sind dabei als solche gekennzeichnet. Die unerlaubte Vervielfältigung oder Weitergabe
                  ...
                  <p>
                    ...
                    durch den Anbieter der Website. Die Darstellung dieser Website in fremden Frames ist nur
                    mit Erlaubnis zulässig.
                  </p>
                </div>
              </div>
              ...
              <div>
                <h2 className="text-2xl font-bold text-navy-900 mb-6">
                  4. DATENSCHUTZ – gesondert verlinkt
                </h2>
                <p className="text-gray-700 leading-relaxed">
                  Unsere&nbsp;
                  <Link
                  ...
                  ist auf einer separaten Seite verlinkt. Bitte klicken Sie auf den Link, um sich über Art,
                  Umfang und Zweck der Erhebung sowie Verwendung personenbezogener Daten zu informieren.
                </p>
              </div>

              {/* Anwendbares Recht */}
              <div>
                <h2 className="text-2xl font-bold text-navy-900 mb-6">5. Anwendbares Recht</h2>
                <p className="text-gray-700 leading-relaxed">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  Nummern&nbsp;1. bis&nbsp;4. abweichen, wird an entsprechender Stelle ausdrücklich darauf
                  hingewiesen. In diesem Falle gelten im jeweiligen Einzelfall die besonderen
                  Nutzungsbedingungen.
                </p>
              </div>
            </div>
...
export async function getStaticProps() {
  return {
    props: {
      title: 'Impressum',
      description:
        'Impressum und rechtliche Angaben von Mario Egartner – C5 Business Partner und Frankfurt Business Coach.'
    }
  }
}
